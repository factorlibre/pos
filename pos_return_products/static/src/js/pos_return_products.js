...
openerp.pos_return_products = function(instance, local) {
    ...
    module.PosWidget = module.PosWidget.extend({
        build_widgets: function() {
            ...
            returnproducts_btn = document.createElement('button');
            returnproducts_btn.innerText = 'Return Products';
            returnproducts_btn.addEventListener('click', _.bind(function () {
                var ss = this.screen_selector;
            ...
            for (var i=0, len=orderlines.length; i<len; i++) {
                ...
                plus_btn.click(_.bind(function () {
                    if (this.qty < this.original_qty) {
                        this.qty += 1;
                        this.html.find('.num')[0].innerText = this.qty;
                    }
                }, orderline));
