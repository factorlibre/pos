...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-pos_margin_stored>=16.0dev,<16.1dev',
        'odoo-addon-pos_meal_voucher>=16.0dev,<16.1dev',
        ...
        'odoo-addon-pos_partner_alternative_pricelist_load_background>=16.0dev,<16.1dev',
        'odoo-addon-pos_partner_birthdate>=16.0dev,<16.1dev',
        'odoo-addon-pos_partner_firstname>=16.0dev,<16.1dev',
        'odoo-addon-pos_partner_is_company>=16.0dev,<16.1dev',
        'odoo-addon-pos_partner_load_new_data>=16.0dev,<16.1dev',
        ...
        'odoo-addon-pos_place>=16.0dev,<16.1dev',
        ...
        'odoo-addon-pos_product_pricelist_alternative>=16.0dev,<16.1dev',
        ...
        'odoo-addon-pos_tare>=16.0dev,<16.1dev',
        'odoo-addon-pos_ticket_extra_company_info>=16.0dev,<16.1dev',
